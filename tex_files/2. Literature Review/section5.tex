...
natural-language scholarly queries (Section~\ref{sec:lr-graph}), and
structured-query translation has been evaluated only on
template-generated scholarly graphs (Section~\ref{sec:lr-nl2q}).  At the
...
(Sections~\ref{subsec:traditional-search}--\ref{subsec:llm-agentic}).
...
optimised Cypher over an OpenAlex-derived schema, and combines BM25,
dense and graph-traversal evidence under a single ranking regime.  
