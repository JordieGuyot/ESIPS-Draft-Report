% ============================================================================
%  Appendix: Deferred Figures and Tables
...
%
%  Heading is set by hand with \section*: IEEEtran's \appendix macro emits its
%  own "Appendix" heading and rewrites \section to drop its argument, so a
%  manual heading is used to get exactly one "Appendix A: ..." line.
% ============================================================================

% Start the appendix on a fresh page (the bibliography ends mid-page above).
\clearpage
\section*{Appendix A: Deferred Figures and Tables}
\addcontentsline{toc}{section}{Appendix A: Deferred Figures and Tables}
