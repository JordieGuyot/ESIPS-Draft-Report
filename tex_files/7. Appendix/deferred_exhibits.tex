...
\footnotesize\itshape
Every configuration is derived read-only from the cached native 1536-dimension fp16 embeddings by truncation, L2 re-normalisation, and quantisation, and scored through the same pipeline as Table~\ref{tab:bienc-results}; the 1536/fp16 row is the sanity condition against that table. All cells are point estimates.
\end{minipage}
\end{table*}
...
\begin{minipage}{\textwidth}
\footnotesize\itshape
Every configuration is derived read-only from the cached native 2560-dimension fp16 embeddings by truncation, L2 re-normalisation, and quantisation, and scored through the same pipeline as Table~\ref{tab:bienc-results}; the 2560/fp16 row is the sanity condition against that table. All cells are point estimates.
\end{minipage}
\end{table*}
